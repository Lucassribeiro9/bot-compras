...
async def add(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.info(f"Produto '{product_name}' adicionado com sucesso para o usuário {chat_id}.")
...
async def list_products(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.info(f"Listando {len(products)} produtos para o usuário {update.effective_chat.id}.")
